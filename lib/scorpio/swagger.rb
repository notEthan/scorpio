...
module Scorpio
  module Swagger
    ...
    swagger_class = proc do |definitions_key|
      Scorpio.class_for_schema(Scorpio::JSON::Node.new(swagger_schema_doc, ['definitions', definitions_key]))
    end

    Document = Scorpio.class_for_schema(Scorpio::JSON::Node.new(swagger_schema_doc, []))
