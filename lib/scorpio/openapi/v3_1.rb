...
module Scorpio
  module OpenAPI
    module V3_1
      ...
      Unscoped::Document = JSI.new_schema_module(YAML.safe_load(Scorpio.root.join(
        'documents/spec.openapis.org/oas/3.1/schema.yaml'
      ).read))
      ...
      Ext::ExtDocument = JSI.new_schema_module(YAML.safe_load(Scorpio.root.join(
        'documents/spec.openapis.org/oas/3.1/schema-base.yaml'
      ).read))
      ...
      Ext::Unscoped::VocabSchema = JSI.new_schema_module(YAML.safe_load(Scorpio.root.join(
        'documents/spec.openapis.org/oas/3.1/meta/base.schema.yaml'
      ).read))
      ...
      Ext::Unscoped::MetaSchema = JSI.new_schema_module(YAML.safe_load(Scorpio.root.join(
        'documents/spec.openapis.org/oas/3.1/dialect/base.schema.yaml'
      ).read))
