...
module Scorpio
  module OpenAPI
    module Reference
      ...
      # Derefable is included on the module of any schema that describes a reference or has an in-place
      # applicator that describes a reference. You can call #deref regardless whether an object is of
      # an expected type, or a reference to one, or a reference to a reference to one.
      module Derefable
